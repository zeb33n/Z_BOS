...
extern "C" void _fault_handler(struct regs* r) {
  // write_base_int(r->int_no, 10, 0xE, 0x1, 1, 1);
  // write_char(r->int_no, 0xE, 0x1, 1, 1);
...
void idt_install() {
  ...
  write_base_int((unsigned long)_isr31, 16, 0xF, 0x1, 1, 3);
  write_base_int((unsigned long)_isr2, 16, 0xF, 0x1, 1, 4);
  // write_base_int((unsigned long)_isr3, 16, 0xF, 0x1, 1, 5);
  // write_base_int((unsigned long)_isr4, 16, 0xF, 0x1, 1, 6);
